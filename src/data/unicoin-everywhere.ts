...
export const unicoinEverywhere: Project = {
    ...
    imageSrc: "unicoin/unicoineverywhere/unicoin-everywhere-09",
    ...
    images: [
        { src: "unicoin/unicoineverywhere/unicoin-everywhere-01", size: "medium" },
        { src: "unicoin/unicoineverywhere/unicoin-everywhere-02", size: "medium" },
        { src: "unicoin/unicoineverywhere/unicoin-everywhere-03", size: "medium" },
        { src: "unicoin/unicoineverywhere/unicoin-everywhere-04", size: "medium" },
        { src: "unicoin/unicoineverywhere/unicoin-everywhere-05", size: "medium" },
        { src: "unicoin/unicoineverywhere/unicoin-everywhere-06", size: "medium" },
        { src: "unicoin/unicoineverywhere/unicoin-everywhere-07", size: "large" },
        { src: "unicoin/unicoineverywhere/unicoin-everywhere-08", size: "large" },
        { src: "unicoin/unicoineverywhere/unicoin-everywhere-10", size: "large" },
        { src: "unicoin/unicoineverywhere/unicoin-everywhere-11", size: "large" },
        { src: "unicoin/unicoineverywhere/unicoin-everywhere-12", size: "large" },
    ],
    content: [  
        {
            type: "text",
