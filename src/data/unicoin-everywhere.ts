// data/unicoin-everywhere.ts
import { Project } from "./types";

export const unicoinEverywhere: Project = {
    slug: "unicoin-everywhere",
    title: "Unicoin is Everywhere",
    imageSrc: "unicoin-everywhere/unicoin-01",
    category: "Campaña & Direccion de arte",
    client: "Unicoin Inc.",
    location: "New York, United State",
    year: 2024,
    services: ["Creative Campaign", "Art Direction", "Global OOH Campaign"],
    images: [
        { src: "unicoin-everywhere/unicoin-02", size: "medium" },
        { src: "unicoin-everywhere/unicoin-03", size: "medium" },
        { src: "unicoin-everywhere/unicoin-04", size: "large" },
        { src: "unicoin-everywhere/unicoin-05", size: "large" },
        { src: "unicoin-everywhere/unicoin-06", size: "medium" },
        { src: "unicoin-everywhere/unicoin-07", size: "medium" },
        { src: "unicoin-everywhere/unicoin-08", size: "large" },
        { src: "unicoin-everywhere/unicoin-09", size: "medium" },
        { src: "unicoin-everywhere/unicoin-10", size: "medium" },
        { src: "unicoin-everywhere/unicoin-11", size: "large" },
        { src: "unicoin-everywhere/unicoin-12", size: "large" },
        { src: "unicoin-everywhere/unicoin-13", size: "medium" },
        { src: "unicoin-everywhere/unicoin-14", size: "medium" },
        { src: "unicoin-everywhere/unicoin-15", size: "large" },
        { src: "unicoin-everywhere/unicoin-16", size: "medium" },
        { src: "unicoin-everywhere/unicoin-17", size: "medium" },
    ],
    content: [  
        {
            type: "text",
