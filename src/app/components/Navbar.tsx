...
const Navbar: React.FC = () => {
    ...
    return (
        <nav
            className={`fixed top-0 left-0 w-full flex items-center justify-between py-4 px-4 sm:px-8 z-50 transition ${scrolled ? "bg-white/90 backdrop-blur-md shadow-md" : "bg-white/70 backdrop-blur-md border-b border-black/10"
                }`}
        >
            ...
            {/* Desktop links */}
            <div className="hidden md:flex items-center space-x-8 text-black text-[22px] font-grotesk">
